...
export const GridScan: React.FC<GridScanProps> = ({
  ...
  }, [sensitivity, lineThickness, linesColor, scanColor, scanOpacity, gridScale, lineStyle, lineJitter, scanDirection, enablePost]); // eslint-disable-line react-hooks/exhaustive-deps
